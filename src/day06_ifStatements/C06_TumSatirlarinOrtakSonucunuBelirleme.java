...
public class C06_TumSatirlarinOrtakSonucunuBelirleme {
    public static void main(String[] args) {
        ...
        if (sayi1 > 0)
        {
            System.out.println("Bırıncı sayı sıfırda buyuk");
        }
        ...
        {
            System.out.println("Nasıl sayı sectın senın aklını skım");
        }
