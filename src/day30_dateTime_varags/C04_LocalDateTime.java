...
public class C04_LocalDateTime {
    public static void main(String[] args) {
        ...
        System.out.println(tarihZaman); //2024-11-25T21:31:28.739280400
        ...
        System.out.println(tarihZaman.format(format1));


        // 25 kasim 2024 19,29
        DateTimeFormatter format2 = DateTimeFormatter.ofPattern("dd MMMM yyyy HH:mm");
        System.out.println(tarihZaman.format(format2)); //25 Kasım 2024 21:45


        // 25 kasim 24 07:29 pm
        DateTimeFormatter format3 = DateTimeFormatter.ofPattern("dd MMM yy hh:mm a");
        System.out.println(tarihZaman.format(format3)); // 25 Kas 24 09:46 ÖS


        // 25.11.24 Pazartesi
        DateTimeFormatter format4 = DateTimeFormatter.ofPattern("dd.MM.yy EEEE ");
        System.out.println(tarihZaman.format(format4)); //25.11.24 Pazartesi


        // 7:29 pm
        DateTimeFormatter format5 = DateTimeFormatter.ofPattern("h:mm a");
        System.out.println(tarihZaman.format(format5)); // 9:52 ÖS

        //  Paz 19:05
        DateTimeFormatter format6 = DateTimeFormatter.ofPattern("EEE HH:mm");
        System.out.println(tarihZaman.format(format6)); // Pzt 21:52
