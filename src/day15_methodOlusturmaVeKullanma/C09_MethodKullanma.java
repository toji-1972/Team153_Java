...
public class C09_MethodKullanma {
    public static void main(String[] args) {
        ...
        C01_FaktoriyelYazdirma.faktoriyelYazdir(8); // 8! = 40320


        // 1453 sayisinin rakamlar toplamini bulun
        C02_SayiniRakamlarToplaminiBulma.rakamlarToplaminiYazdir(1453); // 13


        C03_MetniTerstenYazdirma.terstenMetinYazdirma("Yavas yavas anlamaya basliyoruz");
