...
public class C04_Karsilastirma {
    public static void main(String[] args) {
        ...
        // == ile karsilastirma
        // non-pirimitive data turlerinde farkli data turlerni == ile KARSILASTIRAMAYIZ

        // System.out.println(sb1 == str);
        // Operator '==' cannot be applied to 'StringBuilder', 'String'

        System.out.println(sb1 == sb2); // false
        // 2 StringBuilder == ile karsılastrilirsa
        ...
        // StringBuilder 'da metinleri nasıl karsılastıracagız

        System.out.println(sb1.toString().equals(str)); // true
        System.out.println(sb1.toString().equals(sb2.toString())); // true


        // StringBuilder methodlarıyla yapak istersek
        ...
        StringBuilder sb8 = new StringBuilder("kalan kalir gitmez");

        System.out.println(sb7.compareTo(sb8)); // -14
