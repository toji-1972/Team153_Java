...
public class C03_AvciKuslar extends C02_Kuslar{
    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            parent class
            2ın tum child'lari ile birlikte
            ortak olarak sahip oldugu ozellikleri
            gormek icin kullanırız

            Java'da bir ozelligin variable veya method olarak olusturulmai
         */
        ...
        System.out.println(avciKartal.solunum); // K akcigerle nefes alırlar
        System.out.println(avciKartal.cogalma); // K yuöurtayla cogalirlar
        ...
        System.out.println(avciKartal.gaga); // A sivri gagalıdır

        System.out.println("==============");

        C02_Kuslar kusKartal = new C03_AvciKuslar();
        System.out.println(kusKartal.omur); // H yasar ve olurler
        System.out.println(kusKartal.solunum); // K akcigerle nefes alırlar
        ...
        //System.out.println(kusKartal.pence); // Kuslar ve hayvanlar class'ında yok CTE verir yani kullanamaz
        ...
        //System.out.println(hayvanKartal.kanat); // Hayvanlar class'inda yok CTE verir, yani kullanmaz
        System.out.println(hayvanKartal.hareket);// H hareket ederler
        System.out.println(hayvanKartal.beslenme); // H beslenirler
        // System.out.println(hayvanKartal.pence); // Hayvanlar class'inda yok CTE verir, yani kullanmaz
       // System.out.println(hayvanKartal.gaga); // Hayvanlar class'inda yok CTE verir, yani kullanmaz
        ...
        System.out.println(kus1.solunum); // H nefes alırlar
        System.out.println(kus1.cogalma); // H cogalirlar
       ...
       //  System.out.println(kus1.pence); //Kuslar ve Hayvanlar class'inda yok CTE verir, yani kullanmaz
         System.out.println(kus1.gaga);
        ...
        //System.out.println(hayvanKus.kanat); // Hayvanlar class'ında yok yani CTE verir
        System.out.println(hayvanKus.hareket);// H hareket ederler
        System.out.println(hayvanKus.beslenme); // H beslenirler
        //System.out.println(hayvanKus.pence); // Hayvanlar class'inda yok CTE verir, yani kullanmaz
        //System.out.println(hayvanKus.gaga); // Hayvanlar class'inda yok CTE verir, yani kullanmaz

        // C01_Hayvanlar class ından bir obje olusturun
        ...
        //System.out.println(hayvan1.kanat); // Hayvanlar class'ında yok yani CTE verir
        System.out.println(hayvan1.hareket);// H hareket ederler
        System.out.println(hayvan1.beslenme); // H beslenirler
        //System.out.println(hayvan1.pence); // Hayvanlar class'inda yok CTE verir, yani kullanmaz
        //System.out.println(hayvan1.gaga); //  Hayvanlar class'inda yok CTE verir, yani kullanmaz
